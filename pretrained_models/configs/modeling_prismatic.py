...
class PrismaticForConditionalGeneration(PrismaticPreTrainedModel):
    def __init__(self, config: PrismaticConfig) -> None:
        ...
        if (transformers.__version__ != "4.48.3") or (tokenizers.__version__ != "0.21.0"):
            logger.warning(
                f"Expected `transformers==4.48.3` and `tokenizers==0.21.0` but got "
...
class OpenVLAForActionPrediction(PrismaticForConditionalGeneration):
    ...
    def _regression_or_discrete_prediction(
        ...
        if action_head is not None:
            ...
            if normalized_actions.size() == (1,): return normalized_actions, None # return the result of test-time router
    ...
    def predict_action(
        ...
        **kwargs: str,
        ...
        if not isinstance(normalized_actions, np.ndarray): return normalized_actions, None # return the result of test-time router
